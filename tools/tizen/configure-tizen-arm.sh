#!/bin/bash
# Example configure script for building Kodi dependencies for Tizen ARM devices
...
TIZEN_ROOTSTRAP=${TIZEN_ROOTSTRAP:-tv-samsung-6.0-device.core}
PREFIX=${PREFIX:-$HOME/kodi-tizen-deps}
TARBALLS=${TARBALLS:-$PREFIX/xbmc-tarballs}

# Detect toolchain path
# Tizen Studio may have different toolchain directory structures
TOOLCHAIN_CANDIDATES=(
    "$TIZEN_SDK/tools/arm-linux-gnueabi-gcc-9.2"
    "$TIZEN_SDK/tools/arm-linux-gnueabi-gcc-6.2"
...
# Configure
echo "Configuring dependencies for Tizen ARM..."
./configure \
    --prefix="$PREFIX" \
...
echo "  cmake .. -DCMAKE_TOOLCHAIN_FILE=$PREFIX/arm-tizen-linux-gnueabi-release/share/Toolchain.cmake"
echo "=========================================="
